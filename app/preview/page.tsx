...
export default function PreviewPage() {
  ...
  const publishFallbackUrl = `/success?slug=preview-product&publicUrl=${encodeURIComponent("/p/preview-product")}&checkoutUrl=${encodeURIComponent("https://checkout.locus.so/session/mock-preview")}`;
